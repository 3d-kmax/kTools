...
mc.iconTextCheckBox(label='HypershadePreview', style='iconOnly', font="tinyBoldLabelFont", image=target+"/icons/hyperShade.png", highlightImage=target+"/icons/hyperShade.png", selectionImage=target+"/btn/imageEnable.png", selectionHighlightImage=target+"/btn/imageHighlight.png", height=heightBtn, marginWidth=0, marginHeight=0)
