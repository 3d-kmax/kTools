...
class KMod():
    ...
    def buildUI(cls):
        ...
        allButtons = [('bt_plane', 'polykPlane.png', 'polykPlane.png', 'Plane', 'Create a polygonal plane on the grid', 'kmPlane()', 'pm.mel.CreatePolygonPlaneOptions()'),
                      ('bt_planeDisk', 'polykDisk.png', 'polykDisk.png', 'Plane', 'Create a tuned polygonal plane on the grid', 'kmPlaneDisk()', ''),
                      ('bt_cube', 'polyCube.png', 'polyCube.png', 'Cube', 'Create a polygonal cube on the grid', 'kmPolycube()', 'pm.mel.CreatePolygonCubeOptions()'),
                      ('bt_cubeSphere', 'polykSphere.png', 'polykSphere.png', 'kSphere', 'Create a tuned polygonal cube on the grid', 'kmPolycubeSphere()', ''),
                      ('bt_sphere', 'polySphere.png', 'polySphere.png', 'Sphere', 'Create a polygonal sphere on the grid', 'kmSphere()', 'pm.mel.CreatePolygonSphereOptions()'),
                      ('bt_cylinder', 'polyCylinder.png', 'polyCylinder.png', 'Cylinder', 'Create a polygonal cylinder on the grid', 'kmCylinder()', 'pm.mel.CreatePolygonCylinderOptions()'),
                      ('bt_torus', 'polyTorus.png', 'polyTorus.png', 'Torus', 'Create a polygonal torus on the grid', 'kmTorus()', 'pm.mel.CreatePolygonTorusOptions()'),
                      ('bt_cone', 'polyCone.png', 'polyCone.png', 'Cone', 'Create a polygonal cone on the grid', 'kmCone()', 'pm.mel.CreatePolygonConeOptions()'),
                      ...
                      ('bt_locator', 'locator.png', 'locator.png', 'Locator', 'Create a Locator', 'kmLocator()', ''),
                      ...
                      ('bt_extrude', 'polyExtrudeFacet.png', 'polyExtrudeFacet.png', 'Extrude', 'Extrude the selected component', 'kmExtrude()', 'pm.mel.performPolyExtrude(0)'),
                      ...
                      ('bt_splitPolygon', 'multicutnex.png', 'multicutnex.png', 'SplitFace', 'Split polygon', 'multiCut()', 'pm.mel.InteractiveSplitTool()'),
                      ...
                      ('bt_smooth', 'polySmooth.png', 'polySmooth.png', 'Smooth', 'Smooth mesh', 'kmSmooth()', 'pm.mel.SmoothPolygonOptions()'),
                      ('bt_reduce', 'polyReduce.png', 'polyReduce.png', 'Reduce', 'Reduce Polygon', 'kmReduce()', 'pm.mel.ReducePolygonOptions()'),
                      ...
                      ('bt_softEdge30', 'polyNormalSetAngle.png', 'polyNormalSetAngle.png', 'NormalAngle', 'Set the soft/hard threshold angles for edge normals', 'kmSoftEdge30()', ''),
                      ('bt_setToFace', 'polyNormalSetToFace.png', 'polyNormalSetToFace.png', 'Set to face', 'Set to face', 'kmSetToFace()', ''),
                      ('bt_softEdge180', 'polySoftEdge.png', 'polySoftEdge.png', 'SoftEdge', 'Set the soft/hard threshold angles for edge normals', 'kmSoftEdge180()', ''),
                      ('bt_kmSoftEdge0', 'polyHardEdge.png', 'polyHardEdge.png', 'Set to face', 'Set to face', 'kmSoftEdge0()', ''),
                      ('bt_reverse', 'polyNormal.png', 'polyNormal.png', 'ReverseNormal', 'Reverse the normals of the selected faces', 'kmReverseNormal()', 'pm.mel.ReversePolygonNormalsOptions()',),
                      ('bt_empty_00', '', '', '', '', '', ''),
        ...
        for btnName, imgFileName, imgHltFileName, btnLabel, btnAnnotation, btnCommand, btnDoubleClic in allButtons:
            ...
            if btnName == "bt_empty_00":
                ...
                btnName = mc.iconTextButton(image1=cls.path + imgFileName,
                                            ...
                                            command='KMod().' + btnCommand,
                                            doubleClickCommand=btnDoubleClic,
                                            height=cls.iconSize)

            if imgFileName == "separateHorizontal.png":
                mc.iconTextButton(btnName, edit=True, height=cls.separatorSize, enable=1)
    ...
    def launch(self):
        ...
        mc.workspaceControl(self.wscName, edit=True, minimumWidth=self.iconSize*2+2)
        mc.workspaceControl(self.wscName, edit=True, resizeWidth=self.iconSize*2+2)
        mc.workspaceControl(self.wscName, edit=True, widthProperty="fixed")
        mc.workspaceControl(self.wscName, edit=True, tabPosition=("top", 1))
        mc.workspaceControl("Outliner", edit=True, visible=True)
